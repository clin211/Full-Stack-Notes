...
在可变字体出现之前，每个不同的字体风格都需要单独的文件，这限制了设计师在 Web 上使用丰富字体的能力。可变字体允许在一个单一的文件中包含多个字体风格（如上图），从而减少了文件大小和请求数量，提升了页面加载速度和性能。想了解更多的可变字体相关的内容，可以阅读《[Introducing OpenType Variable Fonts](https://medium.com/variable-fonts/https-medium-com-tiro-introducing-opentype-variable-fonts-12ba6cd2369)》；当然也可以看 [大漠\_w3cpluscom](https://juejin.cn/user/1908407916041614/course) 大佬在掘进上的专栏《[现代 CSS](https://s.juejin.cn/ds/iP43u3L7/)》的 Web 上的可变字体。
...
![](assets/d7306a61-a331-4f88-b15e-ce24054c69f8.png)
...
<html lang="en">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wdth,wght@0,94,280;1,94,280&display=swap" rel="stylesheet" />
        <style type="text/css" media="screen, print">
            @font-face {
                font-family: 'Bitstream Vera Serif Bold';
                src: url('https://mdn.github.io/css-examples/web-fonts/VeraSeBd.ttf');
            ...
            .roboto-font {
                ...
                font-weight: 400;
                font-style: normal;
                font-variation-settings: 'wdth' 494;
            }
        </style>
    </head>
    ...
    <body>
        This is Bitstream Vera Serif Bold.
        <p class="custom-font">This is Oswald.</p>
        <p class="roboto-font">Whereas recognition of the inherent dignity</p>
    </body>
</html>
```

效果如下图：
![](assets/5856d675-0b82-45f9-89dd-dba97b8f1885.png)
...
![](assets/eda9c11c-3c33-45f8-9b04-0e87e84f6ab5.png)
...
![](assets/edb26982-e97f-46e0-a304-664644bba38a.png)
...
- variable
    ...
    ![](assets/bd2a2450-1cbc-4d8b-931f-c9943c203b75.png)

    在浏览器中解析后的效果如下图：
    ![](assets/35fb3e98-3229-4d9c-8ee8-831df8c5c9ba.png)
    ...
    效果如下：
    ![](assets/9d6c22b4-4759-4a81-b707-e7880f896e11.png)

- **declarations**

    进一步自定义 `@font-face` 内容的生成。

    ![QQ_1739870131503](assets/cafbe2df-f814-48b1-ad26-a75b681a052e.png)
...
- 通过 CSS 变量使用
    ...
    ![](assets/681810ee-2210-49f9-9c29-6e287afe0351.png)
...
- 在页面中使用
    ...
    ![](assets/46c4466d-f4f7-467b-9d47-61e463ad4059.png)

    浏览器的效果：
    ![](assets/fe5a3e07-4e8d-42e2-b042-48f3ea4f50cd.png)
...
![](assets/71b121bb-cb40-4a4d-b891-3480e5076599.png)

下面是在 `app/alimama/page.tsx` 中的使用：

```jsx
const page = () => {
    return <div className="font-alimama text-3xl">这是阿里妈妈字体</div>
}
...
效果如下：
![](assets/fdd7aef7-6abf-4945-ae99-0cc2c99f85f8.png)
