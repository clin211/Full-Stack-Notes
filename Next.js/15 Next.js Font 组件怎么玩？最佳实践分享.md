...
```
效果如下：
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/YVIVIO-90860e94-1d90-407c-895d-ad7540ed5fe6.png)

## 可变字体

![来自iconfont的阿里妈妈灵动体](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/wRZDef-18ca4dcc-5ad1-4126-ac6e-9a7313bec7be.gif)
...
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/U7TRZx-bfdffed3-f7b0-4012-80eb-3a80f9acce6d.png)
每个字体的右上角也可以区分哪些字体是可变字体：
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/XhRI12-d7306a61-a331-4f88-b15e-ce24054c69f8.png)
选中一个可变字体之后，进去后可以调整可变字体的版本，然后点击右上角的 “Get font”按钮。如下图：
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/b1ASvt-5ab83dc0-41cb-4dc7-852e-1d0236870e30.png)

可以直接获取代码或者下载字体文件：
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/1j0ko6-e5b7fdb5-e4ae-4c27-87ac-b27898ba92d8.png)

如果选择以远程字体文件引入的方式，则点击 “Get Embed code”后，就可以选择对应的平台的引入代码，如下图：
![QQ_1739785067108](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/mShC3F-c0e2b57b-4ebc-43ad-af3a-7419aa41db2a.png)
...
```
效果如下图：
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/zugQDs-5856d675-0b82-45f9-89dd-dba97b8f1885.png)

有了上面的理论基础后，按照前面的惯例，在进入正题之前，我们先来准备一下相关的环境，创建一个项目便于演示后面的内容。

使用命令 `npx create-next-app@latest --use-pnpm` 创建一个新的项目；具体的项目配置选项如下：

![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/moTBax-34f3ecd4-4317-492a-9246-63e67182829d.png)

在 VS Code 打开以后，项目的依赖如下图：
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/wEkioo-eda9c11c-3c33-45f8-9b04-0e87e84f6ab5.png)
...
最终渲染后的效果如下：
![QQ_1739788489179](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/CDqQB2-b8318790-1e83-46ad-85e7-f1de7d168e18.png)
...
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/NJMduQ-edb26982-e97f-46e0-a304-664644bba38a.png)
...
- **axes**
  ...
  ![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/JjhT7H-a283126b-42ad-48e7-a522-5157541ca813.png)
...
- variable
  ...
  ![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/ybPFkl-bd2a2450-1cbc-4d8b-931f-c9943c203b75.png)

  在浏览器中解析后的效果如下图：
  ![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/DLir3f-35fb3e98-3229-4d9c-8ee8-831df8c5c9ba.png)
  ...
  ```
  效果如下：
  ![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/qgc6zu-9d6c22b4-4759-4a81-b707-e7880f896e11.png)

- **declarations**

  进一步自定义 `@font-face` 内容的生成。
  
  ![QQ_1739870131503](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/W4PNfR-cafbe2df-f814-48b1-ad26-a75b681a052e.png)
...
- 通过 CSS 变量使用
  ...
  ![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/NOXtFW-681810ee-2210-49f9-9c29-6e287afe0351.png)
...
- 将 CSS 变量添加到 `tailwind.config.ts` 配置中
  ...
  ```
  具体配置如下图：
  ![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/mQ8EPm-467c0de7-66d3-401a-90a7-da0fb585d5d4.png)
- 在页面中使用
  ...
  ```
  ![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/OAKX1x-46c4466d-f4f7-467b-9d47-61e463ad4059.png)
  
  浏览器的效果：
  ![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/9UuNQT-fe5a3e07-4e8d-42e2-b042-48f3ea4f50cd.png)
...
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/isvKPa-424ad35a-3cde-4b5e-88bd-e1971e3e7216.png)
> 因为篇幅的问题，就不一步步演示字体的下载，下载字体需要登录！

下载字体后，将字体放入项目中并在 globals.css 中引入，然后创建 `alimama/page.tsx` 文件。 如下图：
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/O26HMR-e9cabcf1-63f0-4ffe-bf4c-e788d55b806f.png)
...
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/MVD2zJ-71b121bb-cb40-4a4d-b891-3480e5076599.png)
...
```
效果如下：
![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/9zTF5Y-fdd7aef7-6abf-4945-ae99-0cc2c99f85f8.png)
...
> ![](https://static-hub.oss-cn-chengdu.aliyuncs.com/notes-assets/X60pRJ-1acdd8c2-6720-4e6f-a241-0d0c288b6e0a.png)
