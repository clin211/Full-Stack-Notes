...
> // settings/page.tsx
> const page = () => {
>     return <div>这里是 dashboard/settings</div>
> }
>
> export default page
> ```
...
> // analytics/page.tsx
> function page() {
>     return <div>这里是 dashboard/analytics</div>
> }
>
> export default page
> ```
...
>         <div>
>             <p>这里是 dashboard</p>
>             {isErr ? Error() : <button onClick={handleOnClickError}>Get Error</button>}
>         </div>
>     )
> }
>
...
>
>     const page = () => {
>         return <div>这里是 @analytics/page.tsx </div>
>     }
>
>     export default page
>     ```
...
>
>     const page = () => {
>         return <div>page-views page</div>
>     }
>
>     export default page
>     ```
...
>
> > 效果可以去 <https://dribbble.com/> 的 Explore inspiring designs 真实体验！
>
> #### 文件约定
>
